  ...
  return (
    <div className="page-wrapper page-info">
      <div className="page-container max-w-narrow">
        <button onClick={onNavigateHome} className="btn-back-link">
          ← Volver al Inicio
        </button>
        ...
        <div className="info-content-body margin-top-md">
          ...
          <p>
            En Hara Vitalis recopilamos información personal básica como tu
            nombre, correo electrónico y número de teléfono al momento de
            registrarte para agendar tus clases de Pilates Reformer.
          </p>

          <h2>2. Uso de la Información</h2>
          <p>
            Utilizamos tus datos únicamente para gestionar tus reservas de
            clases, coordinar tus horarios, comunicarte novedades sobre tu
            suscripción o cambios en el calendario de clases y brindarte una
          ...
          <p>
            ...
            de autenticación de Firebase con cifrado estándar de la industria.
            No compartimos ni vendemos tu información a terceros.
          </p>

          <h2>4. Tus Derechos</h2>
          <p>
            Puedes solicitar la corrección, actualización o eliminación de tus
            datos personales en cualquier momento poniéndote en contacto con
  ...
  return (
    <div className="page-wrapper page-info">
      <div className="page-container max-w-narrow">
        ...
        <h1 className="page-title margin-top-sm">
        ...
        <div className="info-content-body margin-top-md">
          ...
          <p>
            Las reservas de clases de Pilates Reformer deben realizarse con al
            menos 2 horas de anticipación a través de la plataforma. Para
            cancelar una clase reservada sin penalización de cupo, debe
            realizarse con mínimo 15 horas de antelación desde la misma
            plataforma.
          </p>

          <h2>2. Puntualidad y Código de Conducta</h2>
          <p>
            Para no interrumpir la dinámica de la sesión y garantizar el
            correcto calentamiento articular, se otorga una tolerancia máxima de
            10 minutos de atraso. Se recomienda el uso de calcetines
            antideslizantes durante el uso de la máquina Reformer.
          </p>

          <h2>3. Estado Físico y Declaración de Salud</h2>
          <p>
            Es responsabilidad del alumno notificar al instructor sobre
            cualquier lesión previa, cirugía reciente o embarazo antes del
            inicio de la clase para realizar las adaptaciones necesarias en los
            resortes.
          </p>
        </div>
      </div>
    ...
    <div className="page-wrapper page-info">
      <div className="page-container max-w-narrow">
        ...
        <p className="page-lead">
          Estamos aquí para resolver tus dudas y acompañarte en tu práctica de
          Pilates Reformer.
        </p>
        ...
        <div className="grid-2-cols margin-top-lg gap-lg">
          <div className="contact-info-card">
            ...
            <p>
              <strong>Dirección:</strong> Av. Valparaíso 2650, Villa Alemana,
              Chile
            </p>
            <p>
              <strong>Teléfono / WhatsApp:</strong> +56 9 75406035
            </p>
            <p>
              <strong>Correo Electrónico:</strong> por definir
            </p>
            <p>
              <strong>Horario de Atención:</strong> Lunes a Viernes de 10:00 AM
              a 13:00 PM | 16:00 PM a 20:00 PM | Sábados de 09:00 AM a 12:00 PM
            </p>
          </div>
          ...
          >
            ...
            <button type="submit" className="btn-primary margin-top-sm">
              Enviar Mensaje
            </button>
          </form>
        </div>
...
export function FaqPage({ onNavigateHome }) {
  const faqs = [
    ...
    },
    {
      ...
      a: "Puedes cancelar o cambiar tu reserva hasta con 15 horas de anticipación desde tu panel de usuario sin perder la clase de tu paquete.",
    },
    {
  ...
  return (
    <div className="page-wrapper page-info">
      <div className="page-container max-w-narrow">
        ...
        <p className="page-lead">
          Respuestas rápidas a las consultas más habituales sobre nuestras
          clases de Reformer.
        </p>
